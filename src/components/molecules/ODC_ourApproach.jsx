...
import OurApproachData from '../../json/ourapproach.json';
...
const ODC_ourApproach = () => {
    return (
        <>
            <Container>
                <InnerContainer>
                    {OurApproachData.ourApproachBlock.map(data => {
                        return (
                            <>
                    ...
                    <ListBlock>
                        <ListBlock_info>
                            {OurApproachData.hoverBlock1.map(data => {
                                return (<>
                        ...
                        <ListBlock_info>
                            {OurApproachData.hoverBlock2.map(data => {
                                return (<>
                        ...
                        <ListBlock_info>
                            {OurApproachData.hoverBlock3.map(data => {
                                return (<>
                                <img src={'https://secureservercdn.net/160.153.138.71/rpn.c04.myftpupload.com/wp-content/uploads/2020/11/approach__3.png?time=1622425898'} />
                                    <ListBlock_info_para>{data.blockInfo}</ListBlock_info_para>
                                </>)
                            })}
                        </ListBlock_info>
                        <ListBlock_info>
                            {OurApproachData.hoverBlock4.map(data => {
                                return (<>
                                 <img src={'https://secureservercdn.net/160.153.138.71/rpn.c04.myftpupload.com/wp-content/uploads/2020/11/approach__4.png?time=1622425898'} />
                                    <ListBlock_info_para>{data.blockInfo}</ListBlock_info_para>
                                </>)
                            })}
                        </ListBlock_info>
                        <ListBlock_info>
                            {OurApproachData.hoverBlock5.map(data => {
                                return (<>
                                <img src={'https://secureservercdn.net/160.153.138.71/rpn.c04.myftpupload.com/wp-content/uploads/2020/11/approach__5.png?time=1622425898'} />
                                    <ListBlock_info_para>{data.blockInfo}</ListBlock_info_para>
                                </>)
                            })}
                        </ListBlock_info>
                        <ListBlock_info>
                            {OurApproachData.hoverBlock6.map(data => {
                                return (<>
...
export default ODC_ourApproach;